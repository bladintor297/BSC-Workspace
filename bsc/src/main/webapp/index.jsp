...
<html lang="en">
  ...
  <body>
      ...
      <section class="position-relative h-100 pt-5 pb-4">
        ...
        <div class="container d-flex flex-wrap justify-content-center justify-content-xl-end h-100 pt-5">
          <div class="w-100 align-self-end pt-1 pt-md-4 pb-4" style="max-width: 526px;">
            ...
            <p class="text-center text-xl-start pb-3 mb-3">Already have an account? <a href="account-signin.html" class="text-warning">Sign in here.</a></p>
    ...
    <a href="#top" class="btn-scroll-top" data-scroll>
      ...
      <i class="btn-scroll-top-icon  bx-chevron-up"></i>
    </a>
